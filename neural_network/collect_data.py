...
import cv2
import os
import frame    # my file for frame processing
...
class DataCapture(object):
    ...
    def __init__(self, thread_id, name):
        ...
        self.stream = frame.Frame(1, 'SaveFrame')   # setup frame thread
        self.stream.start()     # start frame thread

        self.start()    # start collect data thread
